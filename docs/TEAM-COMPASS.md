...
**מטאפורה:** המועצה-הגבוהה פוסקת **איכות** (האם זה ראוי?). המצפן מורה **כיוון** (האם אנחנו במסלול?). סטודיו-העיצוב (חדש מ-ADR-013) פוסק **אסתטיקה ומותג** (האם זה יפה ומגובש?). שלוש פונקציות שונות — שלושתן הכרחיות.

**הסדר:** מצפן, מועצה, וסטודיו הם 3 צוותים נפרדים, משלימים. סדר-הפעלה לנכס-עיצובי-חדש: Studio (אסתטיקה) → Compass (DoD) → Council (איכות).
